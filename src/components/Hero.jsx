    ...
    <section className="hero-section">
      ...
      <div className="container hero-container">
        <motion.div className="hero-left" initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
          ...
          <h1 className="hero-title">Move people. Send parcels. <span className="highlight-yellow">Keep moving.</span></h1>
      ...
      <style>{`
        ...
        @media(max-width:768px){.hero-section{min-height:auto;padding:1.25rem 0 3rem}.hero-title{font-size:1.9rem}.hero-subtitle{font-size:.88rem;margin-bottom:1rem}.quick-service-pills{margin-bottom:.9rem}.svc-pill{font-size:.72rem;padding:.4rem .75rem}.hero-trust-row{font-size:.7rem}.hero-cta-group{flex-direction:column;align-items:stretch;gap:.6rem}.hero-cta-group .btn-primary-dark,.hero-cta-group .btn-secondary-outline,.hero-cta-group .btn-app-badge,.hero-cta-group .btn-talk-badge{width:100%;justify-content:center;font-size:.82rem;padding:.7rem 1rem}.mobile-cta{display:inline-flex}.phone-wrapper{max-width:330px}.scroll-down-wrapper{margin-top:1rem}}
